export function createSidebar(sideBarDiv, sidebarInitialized) {
	if (!sideBarDiv) {
		...
		<div class="section">
			...
			<div title="Market" class="button" id="market">
				<div class="icon"></div>
		...
		<div class="section">
			...
			<div title="Friends" class="button" id="friends">
				<div class="icon"></div>
	...
	if (!sidebarInitialized) {
		...
		marketBtn.addEventListener('click', () => navigate(false, marketBtn, '/browser', window.opener.urlStore.m_steamUrls.CommunityMarket.url));
		...
		friendsBtn.addEventListener('click', () => window.opener.open('steam://open/friends'));
