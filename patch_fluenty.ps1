...
if ([string]::IsNullOrEmpty($action_choice)) {
    ...
    Write-Host (([char[]](91,50,93,32,1057,1082,1072,1095,1072,1090,1100,44,32,1091,1089,1090,1072,1085,1086,1074,1080,1090,1100,32,1080,32,1087,1088,1086,1087,1072,1090,1095,1080,1090,1100,32,1090,1077,1084,1091,32,70,108,117,101,110,116,121) -join ""))
...
if ($action_choice -eq "Install") {
    Write-Host (([char[]](1057,1082,1072,1095,1080,1074,1072,1085,1080,1077,32,1072,1088,1093,1080,1074,1072,32,1090,1077,1084,1099,32,70,108,117,101,110,116,121,46,46,46) -join "")) -ForegroundColor Cyan
    ...
    try {
        ...
        Write-Host (([char[]](1058,1077,1084,1072,32,70,108,117,101,110,116,121,32,1091,1089,1087,1077,1096,1085,1086,32,1079,1072,1075,1088,1091,1078,1077,1085,1072,32,1080,32,1091,1089,1090,1072,1085,1086,1074,1083,1077,1085,1072,33) -join "")) -ForegroundColor Green
    } catch {
...
Write-Host (([char[]](52,46,32,1055,1077,1088,1077,1079,1072,1087,1091,1089,1090,1080,1090,1077,32,83,116,101,97,109,33) -join ""))
Write-Host "==========================================================" -ForegroundColor Cyan
